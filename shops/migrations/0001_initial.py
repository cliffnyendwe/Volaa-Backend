    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='shops.OptionGroupModel')),
            ],
            options={
                'ordering': ['sort'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_type', models.CharField(choices=[('F', 'Food'), ('G', 'Groceries'), ('P', 'Pharmacy')], max_length=1)),
                ('name', models.CharField(max_length=255)),
                ('slug', models.SlugField(max_length=255, unique=True)),
                ('rating', models.DecimalField(decimal_places=1, default=0, max_digits=2)),
                ('is_active', models.BooleanField(default=False)),
                ('is_open', models.BooleanField(default=True)),
                ('currency', models.CharField(choices=[('$', 'Dollar'), ('€', 'Euro'), ('egp', 'Egyptian Pound')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='shops.ShopProfileModel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='address', to='shops.ShopProfileModel')),
            ],
        ),
        migrations.CreateModel(
            name='RelyOn',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choosed_option_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shops.OptionGroupModel')),
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shops.OptionModel')),
                ('option_group', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='rely_on', to='shops.OptionGroupModel')),
            ],
        ),
        migrations.CreateModel(
            name='ProductModel',
            fields=[
                ...
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='shops.ShopProfileModel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_groups', to='shops.ShopProfileModel'),
        ),
        migrations.AddField(
            model_name='optiongroupmodel',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='option_groups', to='shops.ProductModel'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='shops.ShopProfileModel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField()),
                ('time_stamp', models.DateTimeField(auto_now_add=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='shops.ProductModel')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.UserProfileModel')),
            ],
            options={
                'ordering': ['sort'],
        ...
        migrations.AlterUniqueTogether(
            name='productgroupmodel',
            unique_together={('shop', 'title'), ('shop', 'sort')},
        ),
        migrations.AlterUniqueTogether(
            name='optiongroupmodel',
            unique_together={('product', 'sort')},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort', models.PositiveIntegerField(null=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='add_ons', to='shops.ProductModel')),
            ],
            options={
                'ordering': ['sort'],
                'unique_together': {('product', 'sort')},
